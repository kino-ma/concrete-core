        ...
        + SynthesizesLweCiphertext<Precision, Ciphertext>,
{
    ...
    type RepetitionPrototypes = (<Maker as PrototypesPlaintext<Precision>>::PlaintextProto,);
    ...
    fn generate_random_repetition_prototypes(
        ...
        (maker.transform_raw_to_plaintext(&Precision::Raw::uniform()),)
    }
    ...
    fn prepare_context(
        ...
        let (proto_plaintext,) = repetition_proto;
        let (proto_secret_key, proto_ciph) = sample_proto;
    ...
    fn process_context(
        ...
        let (proto_secret_key, _) = sample_proto;
        let (proto_plaintext,) = repetition_proto;
