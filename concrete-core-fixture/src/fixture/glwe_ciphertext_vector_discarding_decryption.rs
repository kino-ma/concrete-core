...
use concrete_core::prelude::{
    GlweCiphertextVectorDiscardingDecryptionEngine, GlweCiphertextVectorEntity,
        ...
        + SynthesizesGlweCiphertextVector<Precision, CiphertextVector>,
{
    ...
    fn generate_random_sample_prototypes(
        ...
        let proto_output_plaintext_vector = maker.transform_raw_vec_to_plaintext_vector(
            Precision::Raw::zero_vec(parameters.polynomial_size.0 * parameters.count.0).as_slice(),
        );
        (
            proto_plaintext_vector,
    ...
    fn prepare_context(
        ...
        let ciphertext = maker.synthesize_glwe_ciphertext_vector(proto_ciphertext_vector);
