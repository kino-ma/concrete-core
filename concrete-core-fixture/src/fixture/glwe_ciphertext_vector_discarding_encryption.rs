...
use crate::generation::prototyping::{
    PrototypesGlweCiphertext, PrototypesGlweCiphertextVector, PrototypesGlweSecretKey,
        ...
        + SynthesizesGlweCiphertextVector<Precision, CiphertextVector>,
{
    ...
    fn generate_random_sample_prototypes(
        ...
        let proto_ciphertext_vector = maker.trivial_encrypt_zeros_to_glwe_ciphertext();
